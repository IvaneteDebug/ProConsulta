...
var connectionString = builder.Configuration.GetConnectionString("ProConsulta") ?? throw new InvalidOperationException("Connection string 'ProConsulta' not found.");
