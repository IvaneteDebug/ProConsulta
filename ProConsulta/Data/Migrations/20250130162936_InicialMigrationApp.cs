...
{
    /// <inheritdoc />
    public partial class InicialMigrationApp : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "33f0ef9f-3d09-48ba-86d6-500a130e569c", 0, "499f77d6-4455-4ba0-b404-15808f2daa8e", "Atendente", "proconsulta@gmail.com", true, false, null, "Pro Consulta", "PROCONSULTA@GMAIL.COM.BR", "PROCONSULTA@GMAIL.COM.BR", "AQAAAAIAAYagAAAAEHk97wOLPf/4thkpZGhrXuyLKT02NGO07cvbwgelhpFtGIMqCUp+rJCU6VNnec6X/Q==", null, false, "aad38184-5af8-40b5-9d5e-03d9af3804f3", false, "proconsulta@gmail.com.br" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Especialidade médica que cuida do coração", "Cardiologia" },
                    { 2, "Especialidade que trata de doenças e condições da pele.", "Dermatologia" },
                    { 3, "Especialidade focada no tratamento de ossos, músculos .", "Ortopedia" },
                    { 4, "Área médica voltada ao cuidado da saúde infantil.", "Pediatria" },
                    { 5, "Especialidade que trata da saúde do sistema reprodutor feminino.", "Ginecologia" },
                    { 6, "Área da medicina que trata do sistema nervoso.", "Neurologia" },
                    { 7, "Especialidade que cuida da saúde mental e transtornos psicológicos.", "Psiquiatria" },
                    { 8, "Especialidade dedicada ao cuidado da visão e dos olhos.", "Oftalmologia" },
                    { 9, "Especialidade que trata das glândulas e hormônios do corpo.", "Endocrinologia" },
                    { 10, "Área médica que cuida do sistema digestivo.", "Gastroenterologia" }
                });
